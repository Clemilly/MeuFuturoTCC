...
export function TransactionsHeader({
  ...
  const expenseRatio = totalTransactions > 0 ? (stats.total_expenses / totalTransactions) * 100 : 0
  const incomeRatio = totalTransactions > 0 ? (stats.total_income / totalTransactions) * 100 : 0
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="flex-1">
                  ...
                  {showDetailedStats && (
                    <p className="text-xs text-muted-foreground">
                      {formatPercentage(stats.total_income, totalTransactions)} do total
                    </p>
                  )}
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  ...
                  {showDetailedStats && (
                    <p className="text-xs text-muted-foreground">
                      {formatPercentage(stats.total_expenses, totalTransactions)} do total
                    </p>
                  )}
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                <div className={cn(
                  ...
                  <DollarSign className={cn(
                    "h-6 w-6",
                    stats.net_amount >= 0 ? "text-blue-600" : "text-orange-600"
                  )} />
                </div>
                <div className="flex-1">
                  <p className="text-sm font-medium text-muted-foreground">
                  ...
                  {showDetailedStats && (
                    <p className="text-xs text-muted-foreground">
                      {stats.transaction_count} transação{stats.transaction_count !== 1 ? 'ões' : ''}
                    </p>
                  )}
                </div>
              </div>
