...
export function TransactionsFilters({
  ...
  console.log(
    "🔍 DEBUG: TransactionsFilters render - categories count:",
    categories?.length || 0
  );
    ...
    <Card className="border-0 shadow-lg bg-white/80 backdrop-blur-sm">
      <CardContent className="p-4">
        <div className="space-y-4">
            ...
            <div className="flex items-center justify-between pt-4 border-t border-border/50">
              ...
              <div className="flex items-center gap-2">
                <Button
                  ...
                  size="sm"
                  onClick={() => {
                    console.log("🔍 DEBUG: Filtrar button clicked!");
          ...
          {/* Apply filters button when no active filters */}
          {!hasActiveFilters && (
            <div className="flex items-center justify-end pt-4 border-t border-border/50">
              <Button
                ...
                onClick={() => {
                  console.log(
                    "🔍 DEBUG: Filtrar button clicked (no filters active)!"
                  );
                  console.log("🔍 DEBUG: Current filters:", filters);
                  onApplyFilters();
                }}
