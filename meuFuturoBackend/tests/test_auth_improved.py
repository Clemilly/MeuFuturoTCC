...
class TestAuthentication:
    ...
    async def test_verify_2fa_success(
        ...
        async_client: AsyncClient, 
        test_user_with_2fa: dict,
        sample_2fa_data: dict
    ):
        """Test successful 2FA verification."""
        # First login to get pending user
        login_data = {
            "email": test_user_with_2fa["email"],
            "password": "testpassword123"
        }
        ...
        # Verify 2FA (using test code)
        response = await async_client.post("/api/v1/auth/verify-2fa", json=sample_2fa_data)
    ...
    async def test_verify_2fa_invalid_code(
        ...
        # Verify 2FA with invalid code
        invalid_2fa_data = {"code": "000000"}
        response = await async_client.post("/api/v1/auth/verify-2fa", json=invalid_2fa_data)
